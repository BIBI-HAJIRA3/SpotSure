// scripts/seed_shivamogga.js
require('dotenv').config();
const mongoose = require('mongoose');
const fs = require('fs');
const path = require('path');

// Adjust path if your Service model is somewhere else
...
async function run() {
  ...
  const filePath = path.join(__dirname, '..', 'shivamogga_amenities.geojson'); // keep file at repo root
